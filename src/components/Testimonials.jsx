    ...
    return (
        <section id="developers" className="py-20 md:py-32 relative">
            <div className="container mx-auto px-6 text-center mb-16 md:mb-24 animate-on-scroll">
                <h2 className="font-bold text-white mb-4 md:mb-6">Loved by <span className="font-newsreader italic font-normal text-white">passionate</span> builders</h2>
                <p className="text-white/40 max-w-2xl mx-auto font-medium leading-relaxed">Join 10,000+ developers and creators building the future.</p>
            </div>
            ...
            <div className="container mx-auto px-6 columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
                {[
                    ...
                    <div key={i} className="break-inside-avoid glass-card p-8 rounded-[32px] animate-on-scroll">
                        <p className="text-white/80 text-lg mb-8 leading-relaxed font-medium capitalize">"{t.text}"</p>
